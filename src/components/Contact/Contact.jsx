...
const Contact = () => {
  ...
  const onChange = (e) => {
    if (e.target.type === "checkbox")
      setContactInfo({ ...contactInfo, [e.target.name]: e.target.checked });
          ...
          <Row>
            ...
            <Col xs={12} className="emails-check-col">
              <input
                ...
                id="emails-check"
                name="emails-check"
                checked={contactInfo["emails-check"]}
                onChange={onChange}
              />
              <label htmlFor="emails-check">
